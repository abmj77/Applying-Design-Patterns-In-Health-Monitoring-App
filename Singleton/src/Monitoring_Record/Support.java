...
public class Support extends JFrame {
    ...
    private final JLabel Label1 = new JLabel("  YOUTUBE                 @monitoring_recordyoutube", JLabel.LEFT);
    private final JLabel Label2 = new JLabel("  LINKED IN                 @monitoring_recordin", JLabel.LEFT);
    private final JLabel Label3 = new JLabel("  INSTAGRAM             @monitoring_recordinsta", JLabel.LEFT);
    ...
    private final JLabel Label6 = new JLabel("  MEETA                      @monitoring_recordmeeta", JLabel.LEFT);
