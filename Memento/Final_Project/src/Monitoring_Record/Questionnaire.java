...
public class Questionnaire extends JFrame {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == done) {
            StringBuilder allSelectedOptions = new StringBuilder("Updated vital signs:\n");
            ...
            String entry = "[" + timestamp + "] " + allSelectedOptions.toString();

            monitoringWindow.setTextAreaText(entry);
            ...
            if (needsHospitalVisit) {
                ...
                JOptionPane.showMessageDialog(null, "Your vital signs are good " +
                        ...
                        "Note: If symptoms differ significantly, consider medical advice");
            }
            dispose();
        }
    }
